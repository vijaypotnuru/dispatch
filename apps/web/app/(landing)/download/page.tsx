...
export const metadata: Metadata = {
  title: "Download Dispatch",
  description:
    "Download Dispatch for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Dispatch",
    description:
      "Get the Dispatch desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
