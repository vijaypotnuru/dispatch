...
import { Toaster } from "@dispatch/ui/components/ui/sonner";
...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.dispatch.dev"),
  title: {
    default: "Dispatch — Project Management for Human + Agent Teams",
    template: "%s | Dispatch",
  },
  description:
