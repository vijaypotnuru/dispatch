...
const SAMPLE_LATEST_ASSET = {
  name: "dispatch-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/vijaypotnuru/dispatch/releases/download/v0.2.14/dispatch-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "dispatch-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/vijaypotnuru/dispatch/releases/download/v0.2.13/dispatch-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/vijaypotnuru/dispatch/releases/tag/${overrides.tag}`,
