...
import { IssuesPage } from "@dispatch/views/issues/components";
import { ProjectsPage } from "@dispatch/views/projects/components";
import { AutopilotsPage } from "@dispatch/views/autopilots/components";
import { MyIssuesPage } from "@dispatch/views/my-issues";
import { SkillsPage } from "@dispatch/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { AgentsPage } from "@dispatch/views/agents";
import { InboxPage } from "@dispatch/views/inbox";
import { ChatPage } from "@dispatch/views/chat";
import { SettingsPage } from "@dispatch/views/settings";
