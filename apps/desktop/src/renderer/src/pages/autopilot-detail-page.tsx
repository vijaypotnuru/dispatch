...
import { AutopilotDetailPage as AutopilotDetail } from "@dispatch/views/autopilots/components";
import { useWorkspaceId } from "@dispatch/core/hooks";
import { autopilotDetailOptions } from "@dispatch/core/autopilots/queries";
