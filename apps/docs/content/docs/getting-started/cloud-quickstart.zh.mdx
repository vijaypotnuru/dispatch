...
description: Get started with Dispatch Cloud — no setup required.
---

The fastest way to get started with Dispatch — no setup required.

## 1. Sign up

Go to [dispatch.dev](https://dispatch.dev) and create an account.
