---
title: Contributing
description: Local development workflow for contributors working on the Dispatch codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `dispatch` | `dispatch_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U dispatch -d postgres \
