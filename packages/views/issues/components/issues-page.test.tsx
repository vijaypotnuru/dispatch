...
// Mock @dispatch/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@dispatch/core/issues/stores/view-store", () => ({
...
vi.mock("@dispatch/core/issues/stores/view-store-context", () => ({
  ViewStoreProvider: ({ children }: { children: React.ReactNode }) => children,
  useViewStore: (selector?: any) => (selector ? selector(mockViewState) : mockViewState),
  useViewStoreApi: () => ({ getState: () => mockViewState, setState: vi.fn(), subscribe: vi.fn() }),
}));

vi.mock("@dispatch/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@dispatch/core/issues/stores/selection-store", () => ({
...
vi.mock("@dispatch/core/issues/stores/recent-issues-store", () => ({
