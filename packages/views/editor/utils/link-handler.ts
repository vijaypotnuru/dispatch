...
import { isGlobalPath } from "@dispatch/core/paths";
...
/**
 * Open a link — internal paths dispatch dispatch:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("dispatch:navigate", { detail: { path } }),
    );
  } else {
