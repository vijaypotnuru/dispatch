...
import { issueKeys, PAGINATED_STATUSES } from "@dispatch/core/issues/queries";
import type { IssueStatus, ListIssuesCache } from "@dispatch/core/types";
import type { QueryClient } from "@tanstack/react-query";

// Mock the workspace id singleton — items() reads it imperatively.
vi.mock("@dispatch/core/platform", () => ({
  getCurrentWsId: () => "ws-1",
}));
