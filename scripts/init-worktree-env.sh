...
postgres_db="dispatch_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://dispatch:dispatch@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
DISPATCH_SERVER_URL=ws://localhost:${backend_port}/ws
