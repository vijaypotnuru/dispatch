...
var rootCmd = &cobra.Command{
	Use:   "dispatch",
	Short: "Dispatch CLI — local agent runtime and management tool",
	Long:  "Work seamlessly with Dispatch from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.SetVersionTemplate("dispatch {{.Version}}\n")
	...
	rootCmd.PersistentFlags().String("server-url", "", "Dispatch server URL (env: DISPATCH_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: DISPATCH_WORKSPACE_ID)")
